                            ...
                            <div class="col-lg-12">
                                <div class="proceed-checkout">
                                    <ul>
                                        ...
                                        <li class="subtotal mt-3 text-left">Subtotal <span>${{totalHarga}}.00</span>
                                        </li>
                                        <li class="subtotal mt-3 text-left">Pajak <span>10%</span></li>
                                        <li class="subtotal mt-3 text-left">Total Biaya <span>${{totalBiaya}}.00</span>
                                        </li>
                                        <li class="subtotal mt-3 text-left">Bank Transfer <span>Mandiri</span></li>
                                        <li class="subtotal mt-3 text-left">No. Rekening <span>2208 1996 1403</span>
                                        </li>
